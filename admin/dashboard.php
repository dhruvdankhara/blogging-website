...
<main class="container-fluid px-3 px-md-4 py-4">
  <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 gap-2">
    ...
    <small class="text-muted">Welcome back, <?= $name ?></small>
  </div>
    ...
    <div class="col-6 col-lg-3">
      <div class="card border-0 shadow-sm h-100">
        <div class="card-body p-3">
          <div class="d-flex align-items-center">
            <div class="flex-shrink-0">
              <div class="rounded-circle d-flex align-items-center justify-content-center bg-info bg-opacity-10 text-info" style="width: 40px; height: 40px;">
    ...
    <div class="col-12 col-lg-4">
      <div class="card border-0 shadow-sm h-100">
        <div class="card-body p-3 p-md-4 text-center">
          <div class="mb-3">
            <div class="rounded-circle d-flex align-items-center justify-content-center bg-light text-muted mx-auto" style="width: 40px; height: 40px;">
              <i class="bi bi-plus-lg fs-6"></i>
            </div>
          </div>
          <div class="small text-muted mb-2">Quick Actions</div>
          <div class="d-grid gap-2">
            <a href="./category.php" class="btn btn-sm btn-outline-primary">Add Category</a>
            <a href="./promotion_package.php" class="btn btn-sm btn-outline-success">Add Package</a>
          </div>
        </div>
      </div>
    </div>
