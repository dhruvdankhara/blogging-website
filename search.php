  ...
  <?php if (!empty($search_query)): ?>
    <!-- <div class="search-results-header">
      <div class="d-flex justify-content-between align-items-center">
        <div>
          <h4 class="mb-1"><i class="bi bi-search me-2"></i>Search Results</h4>
          <p class="mb-0 text-muted">Results for: "<strong><?= htmlspecialchars($search_query) ?></strong>"</p>
        </div>
    ...
    <div class="row g-3 g-md-4">
      ...
      if ($result_count > 0): ?>
        <!-- <div class="col-12 mb-3">
          <small class="text-muted"><?= $result_count ?> result<?= $result_count > 1 ? 's' : '' ?> found</small>
        </div> -->
                ...
                <div class="d-flex align-items-center flex-wrap gap-2">
                  <div class="d-flex align-items-center flex-grow-1">
                    <img class="rounded-circle me-2 flex-shrink-0" src="<?= $author_image ?>" 
                         onerror="this.src='assets/default-profile.png'" alt="<?= htmlspecialchars($author_name) ?>" 
